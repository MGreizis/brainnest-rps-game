...
function gameController(getPlayerInput, getComputerInput, getRoundWinner) {
  ...
  // Play again option
  const playAgain = prompt('Play Again? Type Yes(Y) or No(N)').toLowerCase()
...
function getPlayerInput(round) {
  let input = prompt(`Round ${round}. Enter rock, paper, or scissors:`)
  // Users types something
  if (typeof input === 'string') {
    input = input.toLowerCase()
  }
  // If the user hits cancel instead
  else {
